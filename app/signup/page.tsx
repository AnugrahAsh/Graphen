  ...
  return (
    <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2 mx-auto min-h-screen bg-white">
      ...
      <form className="flex-1 flex flex-col w-full justify-center gap-2 text-black mt-20 md:mt-0">
        <h1 className="text-5xl font-display font-bold mb-2 text-black tracking-tighter">Deploy <br/><span className="text-maroon">Graphen.</span></h1>
        <p className="text-sm font-medium text-black/60 mb-8">
          Already have an account? <Link href="/login" className="text-maroon hover:underline">Sign in</Link>
        </p>
        ...
        <button
          formAction={signup}
          className="bg-black text-white hover:bg-maroon rounded-xl px-4 py-4 font-bold mb-3 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 duration-200"
        >
